...
public class AutoCompleterAdapter extends RecyclerView.Adapter<AutoCompleterAdapter.PredictionHolder> implements Filterable {
    ...
    private ArrayList<PlaceAutocomplete> getAutocomplete(CharSequence constraint) {
        if (mGoogleApiClient.isConnected()) {
            Log.d("NEWENGLANDOILDEBUG", "Starting autocomplete query for: " + constraint);
            ...
            if (!status.isSuccess()) {
                ...
                Log.d("NEWENGLANDOILDEBUG", "Error getting autocomplete prediction API call: " + status.toString());
                autocompletePredictions.release();
                return null;
            }

            Log.d("NEWENGLANDOILDEBUG", "Query completed. Received " + autocompletePredictions.getCount()
                    + " predictions.");
        ...
        Log.d("NEWENGLANDOILDEBUG", "Google API client is not connected for autocomplete query.");
        return null;
    }
